...
export default function OnboardingScreen() {
  ...
  return (
    <UserScreen>
      ...
      <Pressable onPress={() => replaceRoute("/user/home")} style={styles.primaryButton}>
        <Text style={styles.primaryButtonText}>BAT DAU NGAY</Text>
      </Pressable>
      ...
      <View style={styles.stickyBar}>
        ...
        <Pressable onPress={() => replaceRoute("/user/home")} style={styles.stickyButton}>
